<div class="wrap">
	...
	<h2>Widget Framework - Add New</h2>
...
<?php endif; ?>
	<form method="post">
		<?php wp_nonce_field('add-widget', '_em_widget_framework_nonce'); ?>
		...
		<p class="submit">
			<input id="submit" class="button button-primary" type="submit" name="submit" value="Add Widget" />
		</p>
	</form>
</div>