...
<style type="text/css">
    ...
    <p><?php _e( 'You can also check the Implementation tab to see if your hosting will implement the applicable configuration for you', 'security-header-generator' ); ?>.</p>
            ...
            <ul class="the_list">
                ...
                <li>
                    ...
                    <ul class="the_list">
                        ...
                        <li>
                            <?php _e( 'There is only one directive until the Cross-Origin-Resource-Policy headers are fully browser compatible', 'security-header-generator' ); ?>
                            <ul class="the_list">
