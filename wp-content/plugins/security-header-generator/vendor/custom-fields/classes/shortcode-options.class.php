  ...
  class KPSHG_Shortcoder extends KPSHG_Abstract{
    ...
    public static function add_media_buttons( $editor_id ) {
      ...
      foreach ( KPSHG::$shortcode_instances as $value ) {
        echo '<a href="#" class="button button-primary kpshg-shortcode-button" data-editor-id="'. esc_attr( $editor_id ) .'" data-modal-id="'. esc_attr( $value['modal_id'] ) .'">'. $value['button_title'] .'</a>';
      }
